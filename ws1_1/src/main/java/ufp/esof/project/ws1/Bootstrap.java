...
public class Bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        med1.addConsulta (LocalTime.of (9, 0), c2, "A188", DayOfWeek.FRIDAY,20.0);
        med1.addConsulta (LocalTime.of (10, 0), c3, "A134", DayOfWeek.MONDAY,26.6);

        med2.addConsulta (LocalTime.of (14, 0), c2, "A134", DayOfWeek.TUESDAY,15.4);

        med3.addConsulta (LocalTime.of (13, 0), c1, "A134", DayOfWeek.THURSDAY,14.0);
